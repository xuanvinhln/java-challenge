package challenge.concurrent.diningphilosophers;

/**
 * A simple deadlock-free solution to the dining philosophers problem. Deadlock
 * is prevented by breaking the symmetry between the philosophers. Note,
 * however, that in this version philosophers may still starve.
 */
